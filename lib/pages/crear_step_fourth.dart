...
class CrearStepFourth extends StatefulWidget {

  @override
  CrearStepFourthState createState() => CrearStepFourthState();

}

class CrearStepFourthState extends State<CrearStepFourth> {
